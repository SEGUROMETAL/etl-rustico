import db
import polars as pl
from etl.etl_constantes import TABLA_PRIMAS_RVARIAS
from datetime import date, timedelta
from rutas import PRIMAS_RVARIAS


def etl_primas_ramas_varias_desde_csv(folder_into_data: str = ""):
    """Tomas las primas emitidas  de ramas varias (sin VIDA) y las carga en la tabla primas_ramas_varias.
...
def etl_primas_ramas_varias_desde_mysql(anio=2025):
