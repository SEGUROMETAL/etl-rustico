...
def faltantes_vv_primas_vs_tasas(vv_primas: pl.DataFrame, tasas: pl.DataFrame) -> dict[str, object]:
    dif = vv_primas.join(tasas, how="anti", on=["NumTarifa", "Cap", "Air", "CodCobertura"])
